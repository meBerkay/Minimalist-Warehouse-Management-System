...
namespace depo_yonetim_uygulamasi
{
    public partial class userControlDepo : UserControl
    {
        ...
        private void userControlDepo_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[0].HeaderText = "Ürün Kod";
            dataGridView1.Columns[1].HeaderText = "Depo Adı";
            dataGridView1.Columns[2].HeaderText = "İlgili";
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                {
                    MessageBox.Show("Bütün bilgileri DOLDURMALISINIZ!", "BİLGİLENDİRME", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
