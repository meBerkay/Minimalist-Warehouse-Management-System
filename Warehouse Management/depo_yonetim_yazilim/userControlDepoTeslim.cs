...
namespace depo_yonetim_uygulamasi
{
    public partial class userControlDepoTeslim : UserControl
    {
        ...
        private static readonly SqlConnection sqlConnection = new SqlConnection("Data Source=localhost\\SQLEXPRESS;Initial Catalog=depo_yonetim;Integrated Security=True");
        SqlConnection baglanti = sqlConnection;
        SqlCommand komut;
        SqlDataAdapter da;
        String malzeme;
       ...
       public void Temizle()
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                if (int.Parse(textBox3.Text) > malzemekalanmiktar[index])
                    {
                        MessageBox.Show("ÇIKIŞ YAPILAN MİKTAR DEPODA KALAN MİKTARDAN FAZLA OLMAMALI!", "BİLGİLENDİRME", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        ...
                        {
                            MessageBox.Show("Bütün bilgileri DOLDURMALISINIZ!", "HATA MESAJI", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                        else
                        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    MessageBox.Show("Kalan ürün miktarı 0 altında olamaz! Düzeltip tekrar deneyin.", "HATA MESAJI", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
